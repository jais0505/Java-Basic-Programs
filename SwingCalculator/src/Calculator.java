...
public class Calculator implements ActionListener {
	...
	public Calculator() {
		...
		displayLabel.setBounds(20, 20, 230, 50);
		...
		clearButton.setBounds(200, 85, 50, 30);
		...
		divButton.setBounds(200, 120, 50, 50);
		...
		subButton.setBounds(200, 240, 50, 50);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == sevenButton) {
			...
			displayLabel.setText(result+"");
			break;
			default: displayLabel.setText("Error: Invalid Operation");
